...
<div class="container-fluid bg">
		<div class="row">
            ...
            <div class="col-md-2 col-sm-4 col-xs-12">
				...
				<!-- Form Start -->
            <form class="form-container" method="post" action="AddCarpenterServlet" name="carpenter_registration_form" id="carpenter_registration_form" onsubmit="return validateForm()">
                ...
                <br>
                <button type="button" class="btn btn-danger btn-block" onClick="window.location.href='chiefHallsOfficerUI.jsp'">Back</button>
            </form>
				<!-- Form End-->
            <script>
